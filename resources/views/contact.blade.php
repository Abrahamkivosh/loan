...
<section class="breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url(asset/img/bg-img/13.jpg);">
...
<section class="special-feature-area d-flex flex-wrap">
    ...
    <div class="special-feature-thumbnail bg-img jarallax" style="background-image: url(asset/img/bg-img/20.jpg);"></div>
</section>
...
<section class="special-feature-area style-2 d-flex flex-wrap">
    <!-- Special Feature Thumbnail -->
    <div class="special-feature-thumbnail bg-img jarallax" style="background-image: url(asset/img/bg-img/21.jpg);"></div>
    <!-- Special Feature Content -->
    <div class="special-feature-content section-padding-100">
        <div class="feature-text">
            <!-- Section Heading -->
